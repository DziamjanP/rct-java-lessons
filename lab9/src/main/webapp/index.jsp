    ...
    <my:layout2Columns leftColumnWidth="68%" rightColumnWidth="28%">
        ...
        <my:loginForm>
            <jsp:attribute name="processor">
                <%-- Адрес страницы-обработчика задаѐтся как атрибут
                    processor Т.к. необходимо "склеить" имя страницы
                    с именем контекста, используется JSTL тег c:url
                    --%>
        ...
        <my:registerButton>
            <jsp:attribute name="processor">
                <%-- Адрес страницы с формой регистрации
                    передаѐтся как и для страницы-обработчика
                    формы регистрации --%>
